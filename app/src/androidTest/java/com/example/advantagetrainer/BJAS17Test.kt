...
class BJAS17Test {
    ...
    fun split_v2() {
        ...
        composeTestRule.setContent {
            ...
            with(sharedPref.edit()) {
                clear()
                putInt(Settings.COUNTING_STRATEGY, 2)
                apply()
            }
    ...
    fun deviation_hard_va() {
        ...
        composeTestRule.setContent {
            ...
            playerAction =
                actionResolver.getActionFromStrategy(testUtils.hard11, dealerHand, 1, true)
            assertEquals(Actions.DOUBLE_DOWN, playerAction)
        }
    }
    ...
    fun deviation_hard_va_threeCard() {
        ...
        composeTestRule.setContent {
            ...
            playerAction =
                actionResolver.getActionFromStrategy(testUtils.hard11_threeCard, dealerHand, 1, true)
            assertEquals(Actions.HIT, playerAction)
        }
    }
